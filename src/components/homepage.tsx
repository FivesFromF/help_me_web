...
const featureCards: FeatureCard[] = [
  {
    ...
    description:
      "Chỉ cần hướng camera vào nạn nhân. AI tự động nhận diện và truy xuất thông tin y tế ngay lập tức — không cần chạm, không cần thao tác phức tạp.",
  },
  {
    title: "Thẻ NFC",
    description:
      "Tích hợp chip NFC vào phụ kiện (thẻ, vòng tay, móc khóa). Chỉ cần một chạm từ điện thoại của người hỗ trợ để hiển thị hồ sơ y tế.",
  },
  {
    title: "Mã QR",
    description:
      "Tích hợp mã QR lên màn hình khóa, mũ bảo hiểm hoặc thẻ cá nhân. Đảm bảo thông tin sinh tồn của bạn luôn hiện diện để sẵn sàng được quét bất cứ lúc nào.",
  },
];
...
const faqs: Faq[] = [
  ...
  {
    question: "Nếu tôi thay đổi ngoại hình (đeo kính, đổi kiểu tóc), AI có nhận diện được không?",
    answer:
      "Có thể. Hệ thống được thiết kế để ưu tiên các đặc trưng khuôn mặt ổn định, đồng thời người dùng vẫn có thêm NFC và mã QR như những phương án dự phòng.",
  },
  {
...
function HeroInfo({
  ...
  return (
    <div
      className={cx(
        "max-w-[29rem] pt-2",
        withDivider && "border-t border-[var(--hm-line)] pt-7 sm:border-l sm:border-t-0 sm:pl-6 sm:pt-2",
      )}
    >
      <div className="mb-5 flex h-[7.125rem] items-center text-[var(--hm-orange)]">{icon}</div>
      <h3 className="text-[2rem] font-extrabold leading-none text-[var(--hm-ink)]">{title}</h3>
      <p className="mt-3 text-[1.3rem] leading-[1.7] text-[var(--hm-muted)]">{description}</p>
    </div>
  );
}
  ...
  return (
    <main id="top" className="overflow-x-hidden bg-white text-[var(--hm-ink)]">
      <header className="px-4 pt-6 sm:px-6 xl:px-8">
        <div className="mx-auto max-w-[1320px] rounded-[3rem] border border-[var(--hm-line)] bg-white">
          <div className="flex flex-col gap-4 px-4 py-4 lg:h-[100px] lg:flex-row lg:items-center lg:justify-between lg:px-10">
            <a href="#top" className="block w-[7.5rem] sm:w-[8.6rem]">
              <BrandMark />
            </a>
      ...
      <section className="px-4 pb-4 pt-8 sm:px-6 xl:px-8">
        <div className="mx-auto grid max-w-[1792px] gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(25rem,0.94fr)] lg:items-center">
          <div className="pt-4 lg:pl-[3.9rem]">
            <h1 className="max-w-[9ch] text-[clamp(3.2rem,6vw,6rem)] font-extrabold leading-[1.08] tracking-[-0.05em] text-[var(--hm-ink)]">
              Tai nạn ngỡ ngàng,
              <br />
              thông tin y tế
              <br />
              <span className="italic text-[var(--hm-orange)]">vẫn luôn sẵn sàng</span>.
            </h1>
          ...
          <div className="relative flex min-h-[26rem] items-center justify-center lg:min-h-[54rem] lg:justify-end">
            <div className="relative flex w-full max-w-[52rem] items-end justify-center lg:justify-end">
              <PhoneMockup
                src="/hero-screen-left.png"
                alt="Màn hình ứng dụng HelpMe màu cam"
                priority
                className="relative z-10 aspect-[323/670] w-[14rem] translate-x-4 translate-y-6 rotate-[-12deg] sm:w-[16rem] lg:w-[20rem]"
              />
              <PhoneMockup
                src="/hero-screen-right.png"
                alt="Màn hình ứng dụng HelpMe quét nhận diện"
                priority
                className="relative z-20 -ml-4 aspect-[388/803] w-[16rem] rotate-[11deg] sm:w-[19rem] lg:-ml-3 lg:w-[24rem]"
              />
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="mx-auto max-w-[1717px]">
          <div className="grid gap-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
            <div>
              <h2 className="max-w-[18ch] text-[clamp(2.7rem,4.5vw,4rem)] font-extrabold leading-[1.18] tracking-[-0.045em]">
            ...
            <div className="pt-6 lg:pt-20">
              <h2 className="max-w-[14ch] text-left text-[clamp(2.7rem,4.2vw,4rem)] font-extrabold leading-[1.18] tracking-[-0.045em] lg:ml-auto lg:text-right">
                Và HelpMe ở đây để{" "}
      ...
      <section id="faq" className="px-4 py-24 scroll-mt-20 sm:px-6 xl:px-8">
        <div className="mx-auto grid max-w-[1698px] gap-12 lg:grid-cols-[minmax(18rem,0.8fr)_minmax(0,1fr)] lg:items-start">
          <div className="flex justify-center lg:justify-start">
            <FaqIllustration className="w-full max-w-[34rem]" />
          </div>
        ...
        <div className="mx-auto overflow-hidden rounded-[20px] border border-[var(--hm-line)] bg-white">
          <div className="grid lg:grid-cols-[minmax(0,0.95fr)_minmax(22rem,1.05fr)]">
            <div className="px-8 py-12 sm:px-12 lg:px-14 lg:py-[4.6rem]">
              <h2 className="max-w-[11ch] text-[clamp(2.7rem,4.5vw,4rem)] font-extrabold leading-[1.15] tracking-[-0.045em]">
